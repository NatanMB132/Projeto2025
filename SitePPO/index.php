...
<body>
    <header>
        ...
        <ul class="menu-links">
            ...
            <li class="nada">
                <a href="#" onclick="event.preventDefault(); alert('Em breve para mais atualizações (NÃO AGUENTO MAISSS)');">Atualização1</a>
            </li>
            <li class="nada">
                <a href="#" onclick="event.preventDefault(); alert('Em breve para mais atualizações (NÃO AGUENTO MAISSS)');">Atualização2</a>
            </li>
